...
I visualized the alpha shape using `cassowaryr`. That’s when I saw it:
The alpha hull was overly convex, it had connected the two tips of the U shape, effectively turning it into a bowl. So from the geometry’s point of view, it wasn’t skinny anymore, and the formula reflected that.
...
This didn't align with my understanding of scagnostics. So I returned to the [original Wilkinson paper](https://doi.org/10.1198/106186008X320465), which describes scagnostics in detail.
